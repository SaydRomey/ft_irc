...
INFO_all		:= "Builds the entire project by compiling all source files and linking them into the final executable."
INFO_clean		:= "Removes all object files generated during the compilation process."
INFO_fclean		:= "Performs 'clean' and also removes the compiled executable."
INFO_re			:= "Runs 'fclean' followed by 'all' to rebuild the entire project from scratch."
INFO_run		:= "Compiles the project and runs the executable with default arguments.\n" \
				   "You can specify additional arguments using variables (e.g., make run ARG=xyz)."
INFO_run_wee	:= "Starts the IRC server and connects Weechat to it automatically.\n" \
				   "Useful for testing interactions between the server and client."
INFO_help		:= "Displays a list of all available Makefile targets with short descriptions."

# Add more target descriptions as needed
